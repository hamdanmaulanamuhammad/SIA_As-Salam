...
<div class="container px-5 mx-auto py-6">
    ...
    <div class="flex justify-between items-center mb-6 mt-6">
        ...
        <div>
            <a href="{{ route('akademik.kelas-semester', $kelasSemester->semester->id) }}" class="text-sm px-4 py-2 text-white bg-gray-600 rounded-md hover:bg-gray-700">
                    ...
                    @foreach ($santriList as $index => $santriKelas)
                        <tr class="{{ $index % 2 === 0 ? 'bg-white' : 'bg-gray-50' }}">
                            ...
                            <td class="px-4 py-3 text-sm">
                                <a href="{{ route('akademik.rapor.show', [$kelasSemester->id, $santriKelas->santri->id]) }}"
