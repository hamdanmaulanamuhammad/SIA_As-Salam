...
@section('content')
        ...
        <div class="w-full max-w-2xl bg-white rounded-lg shadow-md p-4 sm:p-6 md:mt-10">
            <div class="flex flex-col items-center space-y-5 sm:flex-row sm:space-y-0">
                ...
                <div class="flex flex-col space-y-3 sm:ml-8">
                    ...
                    <form action="{{ route('profile.admin.deletePhoto') }}" method="POST" class="inline-block" id="delete-photo-form">
                        @csrf
                        @method('DELETE')
            ...
            <div class="mt-6 border-t pt-6">
                ...
                <div class="flex flex-col items-center space-y-4">
                    ...
                    <div class="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4">
                        ...
                        @if($user->signature)
                            <form action="{{ route('profile.admin.deleteSignature') }}" method="POST" id="delete-signature-form">
                                @csrf
                                @method('DELETE')
            ...
            <div class="mt-6 border-t pt-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="role" class="block w-full border border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-200 px-2 py-1 text-sm" value="{{ $user->role }}" readonly />
                </div>
    ...
    <div id="edit-profile-modal" class="fixed inset-0 z-50 flex items-center justify-center hidden bg-black bg-opacity-50">
        <div class="bg-white rounded-lg shadow-lg p-4 sm:p-6 w-full sm:w-11/12 max-w-md max-h-[90vh] overflow-y-auto">
            ...
            <form id="edit-profile-form" action="{{ route('profile.admin.update') }}" method="POST" class="mt-4">
                @csrf
                <div class="mb-4">
    ...
    <div id="change-photo-modal" class="fixed inset-0 z-50 flex items-center justify-center hidden bg-black bg-opacity-50">
        <div class="bg-white rounded-lg shadow-lg p-4 sm:p-6 w-full sm:w-11/12 max-w-md max-h-[90vh] overflow-y-auto">
            ...
            <form id="change-photo-form" action="{{ route('profile.admin.uploadPhoto') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-4">
    ...
    <div id="upload-signature-modal" class="fixed inset-0 z-50 flex items-center justify-center hidden bg-black bg-opacity-50">
        <div class="bg-white rounded-lg shadow-lg p-4 sm:p-6 w-full sm:w-11/12 max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <form id="signature-form" action="{{ route('profile.admin.uploadSignature') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-4">
