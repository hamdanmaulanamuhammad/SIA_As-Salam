                ...
                <div class="w-full">
                    ...
                    <div class="mt-3">
                        ...
                        <div class="border border-black p-2 italic mb-2">
                            Dari {{ $kelasSemester->waliKelas->nama ?? 'Ustadzah' }}
                        </div>
                ...
                <div class="mt-8 grid grid-cols-3 gap-4 text-center text-[10px] no-break">
                    ...
                    <div class="flex flex-col justify-between h-32">
                        ...
                        <div class="signature-container">
                            <img src="{{ asset('storage/rapor/TTD Hamdan Maulana M (1).png') }}" alt="Tanda Tangan Musyrifah">
                        </div>
                        <p class="font-bold">{{ $kelasSemester->waliKelas->nama ?? 'Lili Lailatul Al Fitri' }}</p>
                    </div>
                    <div class="flex flex-col justify-between h-32 mudir-signature-area">
                        ...
                        <div class="signature-container">
                            <img src="{{ asset('storage/rapor/TTD Hamdan Maulana M (1).png') }}" alt="Tanda Tangan Mudir">
                        </div>
                        <div class="cap-container">
                            <img src="{{ asset('storage/rapor/Cap As-Salam.png') }}" alt="Cap/Stempel">
                        </div>
                        <p class="font-bold">{{ $kelasSemester->mudir->nama ?? 'Hamdan Maulana Muhammad' }}</p>
                    </div>
                </div>
            </div>
        </div>
