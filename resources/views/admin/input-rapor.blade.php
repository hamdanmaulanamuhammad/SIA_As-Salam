...
<div class="container px-5 mx-auto py-6">
    ...
    <!-- Form Input Rapor -->
    <form id="rapor-form" action="{{ route('akademik.rapor.update', [$kelasSemester->id, $santri->id]) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="flex justify-end space-x-4">
            ...
            <a href="{{ route('akademik.rapor.preview', [$kelasSemester->id, $santri->id]) }}"
